  ...
  <div class="row align-items-center justify-content-center">
    <div class="col-md-12">
      <div class="mb-5 text-center">
        ...
        <p>Navigate to Your Dream Career Effortlessly.</p>
      </div>
      ...
      @csrf
        <div class="row mb-5">
          ...
          <div class="col-12 col-sm-6 col-md-6 col-lg-3 mb-4 mb-lg-0">
            <select name="region_region" class="selectpicker" data-style="btn-white btn-lg" data-width="100%" data-live-search="true" title="Select Region">
              <option>Anywhere</option>
              <option>Tanger</option>
              <option>Sale</option>
              <option>Temara</option>
              <option>Kennitra</option>
              <option>Casa</option>
              <option>Rabat</option>
...
<div class="container">
  <div class="row mb-5 justify-content-center">
    <div class="col-md-7 text-center">
      ...
      <p class="lead text-white">JobBoard Site Stats: Your Key to Career Success.</p>
    </div>
  </div>
...
<div class="container">
  <div class="row align-items-center">
    <div class="col-md-8">
      ...
      <p class="mb-0 text-white lead">Find Your Perfect Job Today!.</p>
    </div>
    ...
    <div class="col-12 text-center mt-4 mb-5">
      <div class="row justify-content-center">
        <div class="col-md-7">
          ...
          <p class="lead">Trusted by Leading Companies</p>
        </div>
      </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 align-self-center text-center text-lg-left">
          <blockquote>
            <p>&ldquo;The platform is user-friendly, and the customer service is exceptional. Within a month, we filled several key positions that had been vacant for months. I highly recommend JobBoard to any company looking to streamline their recruitment process and find top-notch talent efficiently..&rdquo;</p>
...
<div class="container">
  <div class="row">
    <div class="col-md-6 align-self-center text-center text-md-left mb-5 mb-md-0">
      ...
      <p class="mb-5 lead text-white">.</p>
      <p class="mb-0">
